...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.dbs.flutter_pdf_annotations.FlutterPdfAnnotationsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_pdf_annotations, com.dbs.flutter_pdf_annotations.FlutterPdfAnnotationsPlugin", e);
    }
    try {
